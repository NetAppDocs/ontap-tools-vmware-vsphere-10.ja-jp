...
.手順
. URL： `\https://<srm_ip>:5480`を使用してVMware Live Site Recoveryアプライアンス管理インターフェイスにログインし、VMware Live Site Recoveryアプライアンス管理インターフェイスでStorage Replication Adaptersに移動します。
. [New Adapter]*を選択します。
