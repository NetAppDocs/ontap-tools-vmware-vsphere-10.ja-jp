...
詳細については、 https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vsphere-availability/vcenter-server-high-availability.html["vCenter High Availabilityドキュメント"^]を参照してください。vCenter HAに関するご質問は、 https://support.broadcom.com/["Broadcomサポート"^]までお問い合わせください。
